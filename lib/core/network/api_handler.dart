      ...
      try {
        ...
        if (newTokens != null) {
          ...
          try {
            ...
            throw Exception('Network error on retry: ${retryError.toString()}');
          }
        } else {
        ...
        Logger.error('Token refresh error: ${refreshError.toString()}');
        throw Exception('Authentication error: ${refreshError.toString()}');
      }
    }
